 ...
 * @author Alan Fowler (Some small changes to code, formatting, and comments)
 * @version Winter 2014
 */
public final class ShoppingFrame extends JFrame {
   ...
   */
  private static final Color BG_COLOR = new Color(70, 200, 190);
  ...
  public ShoppingFrame(final List<Item> the_items) {
    ...
    add(makeItemsPanel(the_items), BorderLayout.CENTER);
  ...
  private JPanel makeCheckBoxPanel() {
    ...
    cb.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(final ActionEvent the_event) {
        my_items.setMembership(cb.isSelected());
        updateTotal();
      }
    });
    return p;
  ...
  private void updateTotal() {
    final double total = my_items.calculateTotal();
